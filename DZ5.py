...
# value = 9567586000058500
# zero_count = str(value).count("0")
# print(zero_count)
##############################################################
...
# my_list_1= [8, 10, 15, 4, 2]
# my_list_2= [11, 14, 1, 3, 8]
# my_result = my_list_1[::2] + my_list_2[1::2]
# print(my_result)
###############################################################

# 4. Дан список my_list. СОЗДАТЬ НОВЫЙ список new_list у которого первый
...
# example = "35 больше чем 58 но меньше чем 90"
# parts = example.split()
# result = []
# for value in parts:
#     if value.isdigit():
...
# и поместите эти пары в список.
# Если строка содержит нечетное количество символов, пропущенный
# второй символ последней пары должен
